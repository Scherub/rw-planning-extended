...
{
    readonly List<BaseShapeExtraControlWidget> _shapeExtraContols =
    [
        new DisplayShapeVariantExtraControlWidget(),
        new ShapeRotationExtraControlWidget(),
        new ShapeSegmentExtraControlWidget()
    ];

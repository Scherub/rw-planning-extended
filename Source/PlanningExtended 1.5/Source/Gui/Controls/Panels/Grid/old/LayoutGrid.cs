...
namespace PlanningExtended.Gui.Controls.Grid
{
    ...
    internal class LayoutGrid
    {
        ...
        public LayoutGrid(string columnDefinitions, string rowDefinitions, float columnGap = 0f, float rowGap = 0f)
            : this(columnDefinitions, rowDefinitions, Thickness.Zero, columnGap, rowGap)
        {

        }

        public LayoutGrid(string columnDefinitions, string rowDefinitions, Thickness margin, float columnGap = 0f, float rowGap = 0f)
        {
        ...
        public Rect GetRect(GridPosition gridPosition)
        {
        ...
        float ComputeTrackLength(List<Track> tracks, float availableLength)
        {
            ...
            float totalValue = tracks.Sum(t => t.Definition.Length);

...
| Shape      | Variant            | Rotation | Points / Segments | Modifier                       |
| ---------- | ------------------ | -------- | ----------------- | ------------------------------ |
| Point      | Point              |          | ✔                 | Square                         |
| Line       | Simple Line        |          |                   | Diagonal, Horizontal, Vertical |
|            | Simple Padded Line |          |                   | Diagonal, Horizontal, Vertical |
|            | Line Grid          |          | ✔                 | Square                         |
| Triangle   | Filled             | ✔        |                   | Equilateral                    |
|            | Outline            | ✔        |                   | Equilateral                    |
| Rectangle  | Filled             | ✔        |                   | Square                         |
|            | Grid               |          | ✔                 | Square                         |
|            | Outline            | ✔        |                   | Square                         |
|            | Rounded Filled     |          |                   | Square                         |
|            | Rounded Outline    |          |                   | Square                         |
| Pentagon   | Filled             | ✔        |                   | Square                         |
|            | Outline            | ✔        |                   | Square                         |
| Hexagon    | Filled             | ✔        |                   | Regular                        |
|            | Outline            | ✔        |                   | Regular                        |
| Octagon    | Filled             |          |                   | Square                         |
|            | Outline            |          |                   | Square                         |
| Ellipse    | Filled             |          |                   | Square                         |
|            | Outline            |          |                   | Square                         |
| Fill       | Fill               |          |                   |                                |
| Fill Color | Fill Color All     |          |                   |                                |
|            | Fill Color Same    |          |                   |                                |
...
> Feel free to make any suggestions in one of the created threads (e.g. [Features, Ideas, Suggestions](https://steamcommunity.com/workshop/filedetails/discussion/2877392159/3487500856961565142/). If you prefer [GitHub](https://github.com/Scherub/rw-planning-extended/issues), you can also create new issues there. If you feel confident, you're more than welcome to branch the code and create a pull request for a newly implemented feature.
>
> Please, also have a look at the [GitHub repository](https://github.com/Scherub/rw-planning-extended) / [GitHub project](https://github.com/users/Scherub/projects/2) for already existing issues.

### I really want this mod available in my native language!
> Unfortunately, I'll have to rely on the community here. I'm only fluent in German and English, for everything else I require the help from one of you. If you're willing to help, then [here](https://github.com/Scherub/rw-planning-extended/blob/develop/Common/Languages/English/Keyed/Translations.xml) are the language files to translate. Start with translating the English file, then have a look at the other languages (e.g. German), as there are more files with translations for keybindings, etc.
